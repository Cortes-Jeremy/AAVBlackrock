...
function AAV_CombatText:setValue(p, type, amount, crit)
	...
	if (crit == 0) then self.text:SetFont("Interface\\Addons\\AAVBlackrock\\res\\Fonts\\PTSansNarrow.TTF", AAV_COMBATTEXT_SCROLLINGTEXTFONTSIZE, "NONE") end
	if (crit == 1) then self.text:SetFont("Interface\\Addons\\AAVBlackrock\\res\\Fonts\\PTSansNarrow.TTF", AAV_COMBATTEXT_SCROLLINGTEXTCRITPLUS, "NONE") end
